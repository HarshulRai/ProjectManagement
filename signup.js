...
signupButton.addEventListener('click', (e)=>{
    ...
    if(name.value === ''){
        ...
        gender.placeholder = "Please specify your gender"
        gender.classList.add("empty")
    }
    else{
        let userDetails = {
            name: name.value, email:email.value, phone:phone.value, password: password.value, age: age.value, gender: gender.value
        }
